...
<head>
    ...
    <style>
        ...
        .auth-card { width: 100%; max-width: 400px; background: rgba(255, 255, 255, 0.95); backdrop-filter: blur(10px); opacity: 0; /* Hidden for Anime.js */ }
    </style>
</head>
<body>
    ...
    <div class="auth-wrapper container">
        <div class="card auth-card shadow-lg border-0 rounded-4 p-4">
            <div class="card-body">
                <h3 class="text-center mb-4 fw-bold">System Login</h3>
                ...
                <form action="/loginAuth" method="post">
                    ...
                    <button type="submit" class="btn btn-primary btn-lg w-100 mb-3 shadow-sm">Secure Login</button>
                </form>
    ...
    <script>
        // 1. Initialize Particles.js (Simple constellation effect)
        ...
        // 2. Initialize Anime.js (Smooth card entrance)
        anime({
            targets: '.auth-card',
            translateY: [-50, 0],
            opacity: [0, 1],
